...
```text
ghcr.io/flynx9/cartavault:1.0.0-rc.2
```
...
docker image inspect ghcr.io/flynx9/cartavault:1.0.0-rc.2
```
...
```powershell
.\docker\build.ps1 -Version "1.0.0-rc.2"
```

Export the two standard images for an offline NAS or Portainer installation:

```powershell
.\docker\export-images.ps1 -Version "1.0.0-rc.2" -OutputDirectory "D:\docker-exports"
```

The archive contains `cartavault:1.0.0-rc.2` and the digest-pinned
