...
docker image inspect ghcr.io/flynx9/cartavault:1.0.0-rc.3
```
...
```powershell
.\docker\export-images.ps1 -Version "1.0.0-rc.3" -OutputDirectory "D:\docker-exports"
```

The archive contains `cartavault:1.0.0-rc.3` and the digest-pinned
