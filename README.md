...
Les synthèses distinguent strictement la **distance de route** et le **temps de conduite** fournis par le moteur de routage des durées de visites, pauses, marges et de la durée planifiée totale. Une journée sans itinéraire ou dont l’ordre a changé n’est pas comptée comme une route à zéro : le total global est signalé comme partiel jusqu’au recalcul. La comparaison d’optimisation présente simultanément les distances et les temps de conduite avant/après.
