...
SECURITY_HEADERS = {
    "content-security-policy": (
        ...
        "img-src 'self' data: blob: https://tile.openstreetmap.org https://*.arcgis.com https://*.arcgisonline.com "
        "https://*.google.com https://*.googleapis.com https://*.gstatic.com; "
        "font-src 'self' data: https://fonts.gstatic.com; "
        "connect-src 'self' https://tiles.openfreemap.org https://*.arcgis.com https://*.arcgisonline.com "
        "https://*.google.com https://*.googleapis.com https://*.gstatic.com; "
