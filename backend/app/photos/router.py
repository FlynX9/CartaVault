...
def create_place_photo(
    ...
    quotas.ensure_can_create(current_user.id, QuotaKey.PHOTOS_PER_PLACE_MAX, scope_id=place_id)
    quotas.ensure_can_create(place.map.owner_id, QuotaKey.PHOTOS_TOTAL_MAX)
