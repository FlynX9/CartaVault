...
Chaque journée affiche séparément la route, la conduite, les visites, les pauses/marges et la durée totale estimée. Le résumé du voyage sépare de la même façon le trajet total de la durée planifiée. Les distances utilisent le format français en kilomètres et les durées restent en heures cumulées, même au-delà de 24 heures. Une journée non calculée ou obsolète affiche un état explicite et rend le résumé global partiel jusqu’au prochain calcul.
