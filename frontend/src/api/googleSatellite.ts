...
export const createGoogleSatelliteSession = (mapType: 'roadmap' | 'satellite' = 'satellite') => sendJsonViaXhr('/basemaps/google-satellite/session', 'POST', { map_type: mapType }) as Promise<GoogleSatelliteSession>
