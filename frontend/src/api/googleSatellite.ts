import { getJson, sendBodyWithoutResponse, sendJson, sendWithoutResponse } from './client'
...
export interface GoogleSatelliteAdminStatus {
  configured: boolean; masked_value: string | null; verified: boolean; verified_at: string | null; last_used_at: string | null; last_error_code: string | null; available: boolean; warning_level: number
...
export const saveGoogleSatelliteCredential = (value: string) => sendJson('/admin/console/google-satellite/credential', 'PUT', { value }) as Promise<GoogleSatelliteAdminStatus>
export const verifyGoogleSatelliteCredential = () => sendJson('/admin/console/google-satellite/verify', 'POST', {}) as Promise<GoogleSatelliteAdminStatus>
export const deleteGoogleSatelliteCredential = () => sendWithoutResponse('/admin/console/google-satellite/credential', 'DELETE')
