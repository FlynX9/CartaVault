...
import type { Trip, TripDay, TripDeparture, TripExport, TripNight, TripOptimization, TripStop, TripSummary, TripVisitStatus } from '../types/trip'
...
export const startTrip = (id: string) => sendJson(`/trips/${id}/start`, 'POST', {}) as Promise<Trip>
export const completeTrip = (id: string) => sendJson(`/trips/${id}/complete`, 'POST', {}) as Promise<Trip>
