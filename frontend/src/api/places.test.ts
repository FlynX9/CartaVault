...
const base = { id: PLACE_ID, map_id: MAP_ID, name: 'Manufacture', longitude: 6.45, latitude: 48.17, status: { id: 'cccccccc-cccc-4ccc-8ccc-cccccccccccc', color: '#2563EB' }, primary_category_icon: null, category_ids: [], tag_ids: [], is_favorite: false }
...
describe('normalized place API', () => {
  ...
  it('validates detailed map and country summaries with optional resolved country', () => {
    const place = parsePlaceDetailsResponse({ ...base, status: { ...base.status, map_id: MAP_ID, name: 'À faire', slug: 'a-faire', functional_state: 'non_visited', is_active: true }, categories: [], tags: [], description: null, map: { id: MAP_ID, name: 'France', country: { id: COUNTRY_ID, iso_alpha2: 'FR', iso_alpha3: 'FRA', name: 'France' } }, region: null, construction_date: null, abandonment_date: null, condition: null, access: null, danger_level: null, created_at: '2026-07-13T10:00:00', updated_at: '2026-07-13T10:00:00' })
