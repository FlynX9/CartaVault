...
export function AdminUsersSection() {
  ...
  const requestRoleChange = async (item: AdminUser, nextRole: AdminRole) => {
    ...
    if (!await confirm({ title: `${action} ${item.display_name}`, message: nextRole === 'admin' ? 'Cet utilisateur deviendra administrateur et pourra gÃ©rer lâ€™instance.' : 'Cet utilisateur perdra ses droits dâ€™administration.', confirmLabel: action, variant: 'positive' })) return
