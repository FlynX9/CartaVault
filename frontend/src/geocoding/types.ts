...
export interface GeocodingResult { id: string; name: string; formattedAddress: string; latitude: number; longitude: number; countryCode?: string; countryName?: string; region?: string; locality?: string; layer?: string; source: string; confidence?: number; boundingBox?: GeocodingBoundingBox }
