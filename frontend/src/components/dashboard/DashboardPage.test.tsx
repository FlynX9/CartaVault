...
describe('DashboardPage', () => {
  ...
  it('renders accessible aggregates, recent content and the lightweight map preview', async () => {
    render(<DashboardPage activeMapEditable {...callbacks} />)
  ...
  it('reuses the existing workflows and disables write actions for a viewer', async () => {
    const firstRender = render(<DashboardPage activeMapEditable={false} {...callbacks} />)
    ...
    expect(callbacks.onCreatePlace).toHaveBeenCalledOnce()
    expect(callbacks.onImportKmz).toHaveBeenCalledOnce()
    expect(callbacks.onCreateTrip).toHaveBeenCalledOnce()
  })
  ...
  it('renders a stable empty state', async () => {
    ...
    render(<DashboardPage activeMapEditable={false} {...callbacks} />)
