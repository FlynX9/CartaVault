...
vi.mock('../../api/account', () => ({ getAccountPreferences: vi.fn().mockResolvedValue({ language: 'fr', preferred_basemap: 'openfreemap-light', density: 'compact', startup_panel: 'maps', timezone: 'Europe/Paris', trash_retention_days: 30, routing: { provider: 'osrm' }, places: { provider: 'stadia' }, onboarding: { dismissed: true, completed_steps: [] } }), updateAccountPreferences: vi.fn() }))
