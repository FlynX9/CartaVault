...
describe('workspace management panels', () => {
  it('renders compact category actions and its shared search field', async () => {
    ...
    expect(screen.getByRole('button', { name: 'Créer une catégorie' })).toHaveClass('panel-icon-button', 'panel-create-action')
  ...
  it('renders compact tags without changing the CRUD search behavior', async () => {
    ...
    expect(screen.getByRole('button', { name: 'Créer un tag' })).toHaveClass('panel-create-action')
