...
export const categoriesConfig = (mapId?: string): EntityManagementConfig => ({
  singularLabel: 'une catégorie', pluralLabel: 'Catégories', newLabel: 'Nouvelle catégorie', supportsDescription: true, supportsIcon: true, mapId, profileResourceType: 'categories',
...
export const tagsConfig = (mapId?: string): EntityManagementConfig => ({
  singularLabel: 'un tag', pluralLabel: 'Tags', newLabel: 'Nouveau tag', supportsDescription: false, supportsColor: true, mapId, profileResourceType: 'tags',
